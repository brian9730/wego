...
import post1Image from "../images/logo.svg.png";
import post2Image from "../images/logo-dark.svg.png";
                    ...
                    <img
                      ...
                      src={
                        post.image
                          ...
                          : darkMode
                            ? post1Image  // 다크 모드일 땐 어두운 로고
                            : post2Image  // 라이트 모드일 땐 밝은 로고
                      }
                      alt={post.name}
                      className="saved-card-image"
                      onError={(e) => {
                        e.target.src = darkMode ? post2Image : post1Image;
                      }}
                    />
